const darkMode = (e) => {
  if (e) {
      ...
      1 == e.checked
          ? (document.body.classList.add("dark-mode"), d.classList.add("dark-mode"), localStorage.setItem("nightmode", !0), (document.getElementById("nightmode").checked = !0))
          : (document.body.classList.remove("dark-mode"), d.classList.remove("dark-mode"), localStorage.removeItem("nightmode"), (document.getElementById("nightmode").checked = !1));
  } else {
